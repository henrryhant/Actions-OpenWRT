...
sed -i "s/DISTRIB_REVISION='%R'/DISTRIB_REVISION='V2020.0217 By Greenice'/" package/base-files/files/etc/openwrt_release

sed -i '/REDIRECT --to-ports 53/d' package/network/config/firewall/firewall.user
